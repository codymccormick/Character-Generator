...
// import { generateEnemy } from './madeAnEnemy.js';
// import { generateHeft } from './heft.js';
  ...
  switch (true) {
    ...
    case tragedyRoll >= 5 && tragedyRoll <= 6:
      return {
        ...
        type: 'Debt',
        description:
          'Financial or otherwise, you make yourself indebted to someone or some group.', //Roll on the enemy and heft tables to determine what kind and how powerful they are.
        // enemy: generateEnemy(),
        // heft: generateHeft(),
      };
